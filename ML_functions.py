...
def gen_events(m, N_sources, q, rho_dm, data, iso=True, surtime = 4400, baryons = True, random = False):
    cutoff = 1.0
...
def max_f(m, N_sources, q, rho_DM, err_baryons = 0.05, logfexp = 0, req_prob = 0.95, data = data0, surtime = 4400, baryons = True, random = False):
    events, T = gen_events(m, N_sources, q, rho_DM, data, surtime = surtime, baryons = baryons, random = random)
